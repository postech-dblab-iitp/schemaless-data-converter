...
ALTER TABLE forum_p1 ADD PRIMARY KEY (f_forumid);
ALTER TABLE forum_p2 ADD PRIMARY KEY (f_forumid);
ALTER TABLE organisation ADD PRIMARY KEY (o_organisationid);
ALTER TABLE person_p1 ADD PRIMARY KEY (p_personid);
ALTER TABLE person_p2 ADD PRIMARY KEY (p_personid);
ALTER TABLE person_p3 ADD PRIMARY KEY (p_personid);
ALTER TABLE person_p4 ADD PRIMARY KEY (p_personid);
ALTER TABLE person_p5 ADD PRIMARY KEY (p_personid);
...
ALTER TABLE forum_person_p1 ADD PRIMARY KEY (fp_forumid, fp_personid);
ALTER TABLE forum_person_p2 ADD PRIMARY KEY (fp_forumid, fp_personid);
...
CREATE INDEX forum_person_forumid_p1 ON forum_person_p1 (fp_forumid);
CREATE INDEX forum_person_personid_p1 ON forum_person_p1 (fp_personid);
CREATE INDEX forum_person_forumid_p2 ON forum_person_p1 (fp_forumid);
CREATE INDEX forum_person_personid_p2 ON forum_person_p2 (fp_personid);
...
CREATE INDEX person_placeid_p1 ON person_p1 (p_placeid);
CREATE INDEX person_placeid_p2 ON person_p2 (p_placeid);
CREATE INDEX person_placeid_p3 ON person_p3 (p_placeid);
CREATE INDEX person_placeid_p4 ON person_p4 (p_placeid);
CREATE INDEX person_placeid_p5 ON person_p5 (p_placeid);
